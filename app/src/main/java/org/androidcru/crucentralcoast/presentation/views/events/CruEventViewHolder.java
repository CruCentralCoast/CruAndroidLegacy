...
public class CruEventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private void bindUI()
    {
        ...
        fbButton.setImageDrawable(DrawableUtil.getTintedDrawable(context, R.drawable.ic_facebook_box_grey600_48dp, R.color.fbBlue));
        mapButton.setImageDrawable(DrawableUtil.getTintedDrawable(context, R.drawable.ic_map_marker_grey600_48dp, R.color.red600));
