...
public class EventsAdapter extends RecyclerView.Adapter<EventsAdapter.CruEventViewHolder>
{
    ...
    public EventsAdapter(Activity parent, ArrayList<CruEventVM> cruEvents, LinearLayoutManager layoutManager, Observer<Pair<String, Long>> onCalendarWritten)
    {
        this.mParent = parent;
    ...
    public void onBindViewHolder(CruEventViewHolder holder, int position)
    {
        ...
        holder.calButton.setSelected(cruEventVM.mAddedToCalendar);
        holder.calButton.setImageDrawable(DrawableUtil.getTintListedDrawable(mParent, cruEventVM.mAddedToCalendar
